...
@endif
<div class="row" ng-app="barangdetail" ng-controller="outController">
	...
	<div class="card col-md-4">
		...
		<div class="row">
			<div class="{{ $dtstatus =='disabled' ? 'hidden' : 'col-md-12'}}">
				<a href="{{ url('transaksikeluar/'. $datadetail->number .'/simpan') }}" class="btn btn-default btn-block" style="margin-top: 15px; color: #636b6f; border-bottom: 5px solid #FDE088;">
					SIMPAN
				</a>
			</div>
			<div class="col-md-12">
				<a href="{{ url('barangkeluar') }}" class="btn btn-default btn-block" style="margin-top: 15px; color: #636b6f; border-bottom: 5px solid #F4645F;">
					KEMBALI
				</a>
			</div>
